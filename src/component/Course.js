    ...
    <div>
      <div className="divTwo">
         <section className="headingSec">
            <h1><span className="highlight">Courses</span> We Offer</h1>
            <p>
               Discover excellence in education at Sanjivani. Our curated courses blend 
         ...
         <section className="firstSec">
            <section className="courseSec">
               <h3>Undergraduate Programs</h3>
               <p>
                  For decades, Sanjivani College has improved the health of our communities, one graduate 
            ...
            <section className="courseSec">
               ...
               <p>
                  Building on our strong roots in leadership, health care and education, Sanjivani is proud 
                  to offer an array of coed graduate programs for women and men who are ready to advance 
                  their careers and grow as leaders. The Sanjivani College Community Psychology Master's 
            ...
            <section className="courseSec">
               ...
               <p>
                  The Sanjivani, as one of the largest nursing schools in Wisconsin, offers a wide array of 
                  fully accredited nursing programs, guaranteed clinical placements and a technology-rich 
                  Center for Clinical Education. The Sanjivani College Community Psychology Master's program 
